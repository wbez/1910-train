...
PROJECT_SLUG = '1910-train'

# Project name to be used in file paths
PROJECT_FILENAME = '1910_train'

# The name of the repository containing the source
REPOSITORY_NAME = '1910-train'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1kfduIN1aQ-r16FNtrqdeiwxEC_JjDWotvG49RunMZ-U'
