...
```
* * * * * ubuntu bash /home/ubuntu/apps/1910_train/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|1910-train|tweet|`location`||
|1910-train|facebook|`location`||
|1910-train|email|`location`||
|1910-train|new-comment||
|1910-train|open-share-discuss||
|1910-train|close-share-discuss||
|1910-train|summary-copied||
|1910-train|featured-tweet-action|`action`|
|1910-train|featured-facebook-action|`action`|
